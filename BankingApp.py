...
def startup(confirm):
    ...
    while run:
      if confirm == "yes" or confirm == "y":
        transaction_option()
      else if confirm == "no" or confirm == "n" or confirm == "quit" or confirm == "q":
        print("Exiting...")
        sys.exit()
      else if confirm == "clear" or confirm == "c":
          addStartingBalance()
      else:
        print("Input invalid")
        prompt()
...
def transaction_option():
    ...
    if change == "deposit" or change == "d":
        deposit_money()
    else if change == "withdrawal" or change == "w":
        withdrawMoney()
    else if change == "quit" or change == "exit":
        print("Exiting...")
        sys.exit()
    else:
        print("Invalid input")
